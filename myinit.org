...
#+BEGIN_SRC emacs-lisp
  ...
  ;;(set-face-attribute 'default "-*-fira mono medium-medium-*-*-*-*-*-*-*-*-*-*-*")
...
* ansi-term
#+BEGIN_SRC emacs-lisp
  ;; (define-key term-mode-map (kbd "C-s") 'helm-swoop-without-pre-input)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package wolfram-mode
    ...
    (key-binding (wolfram-mode-map) (kbd "C-c C-c") 'wolfram-send-last-mathexp))
#+END_SRC
