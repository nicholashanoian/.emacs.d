...
#+BEGIN_SRC emacs-lisp
  (use-package js2-mode
    :ensure t
    :config
 (add-to-list 'auto-mode-alist '("^(?!\\.component\\.js$).*\\.js$" . js2-mode))
...
#+BEGIN_SRC emacs-lisp
    ...
    and open a Pipenv shell and a Python interpreter."
        ...
        (when (pipenv-project?)
          (pipenv-activate)
          (run-python)))
      ;;(define-key python-mode nhh-pipenv-start-python)
      )
  ...
  and open a Pipenv shell and a Python interpreter."
      ...
      (when (pipenv-project?)
        (pipenv-activate)
        (run-python)))
;;    (define-key python-mode (kbd "C-c C-p") nhh-pipenv-start-python)
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;   :config
  ;;   (define-key matlab-mode-map (kbd "M-RET") #'matlab-comment-return)
  ;;   (define-key matlab-mode-map (kbd "C-c C-c") #'matlab-shell-run-cell)
  ;;   (define-key matlab-mode-map (kbd "M-;") #'comment-line)
  ;;   ;;(setq mlint-programs (list "/usr/local/MATLAB/R2018b/bin/glnxa64/mlint"))
  ;;   ;; (setq mlint-program "/usr/local/MATLAB/R2018b/bin/glnxa64/mlint")
  ...
  (setq matlab-server-executable "/usr/local/MATLAB/R2018b/bin/matlab")
