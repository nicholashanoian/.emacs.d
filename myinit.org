...
#+RESULTS:
| (lambda nil (setq TeX-command-list (cons (quote (Make latexmk -outdir=/tmp %t TeX-run-TeX nil t :help Make pdf output using latexmk.)) TeX-command-list))) | TeX-PDF-mode | reftex-mode | LaTeX-math-mode | turn-on-cdlatex |
...
#+RESULTS:
| (lambda nil (org-bullets-mode 1)) | #[nil \300\301\302\303\304$\207 [org-add-hook change-major-mode-hook org-show-block-all append local] 5] | #[nil \300\301\302\303\304$\207 [org-add-hook change-major-mode-hook org-babel-show-result-all append local] 5] | org-babel-result-hide-spec | org-babel-hide-all-hashes |
