(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(web-mode virtualenvwrapper all-the-fonts all-the-icons neotree exec-path-from-shell python-mode electric-operator anaconda-mode company-jedi helm-projectile projectile multiple-cursors js2-refactor js2-mode groovy-mode gradle-mode meghanada eclimd helm-org helm-files tex-site helm-swoop color-theme-sanityinc-tomorrow try ace-window auto-org-md org-edna org-bullets company-emacs-eclim eclim pdf-tools markdown-mode magit cdlatex avy-flycheck aggressive-indent auctex company helm flycheck diminish use-package)))
