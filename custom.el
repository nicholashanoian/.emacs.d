(custom-set-variables
 ...
 '(org-agenda-files (quote ("~/Dropbox/org/gcal.org")))
 '(org-file-apps
   (quote
	((auto-mode . emacs)
	 ("\\.mm\\'" . default)
