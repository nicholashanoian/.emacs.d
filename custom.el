...
(custom-set-faces
 ...
 '(ein:cell-input-area ((t (:background "gray20"))))
 '(ein:cell-output-area ((t nil)) t)
 '(ein:cell-output-stderr ((t (:foreground "#cc9393"))))
